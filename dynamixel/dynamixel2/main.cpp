...
int main(void)
{
    ...
    while(true)
    {
        ...
        if (mx.kbhit()) //키보드입력 체크
        {
            ...
            switch(c)
            {
            case ' ': vel1 = 0; vel2 = 0; break; //정지
            case 'w': vel1 = 50; vel2 = -50; break; //전진
            case 's': vel1 = -50; vel2 = 50; break; //후진
            case 'a': vel1 = -50; vel2 = -50; break; //좌회전
            case 'd': vel1 = 50; vel2 = 50; break; //우회전
